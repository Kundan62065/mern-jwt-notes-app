    ...
    <div className="relative w-full md:h-[700px] h-screen bg-green-50 overflow-hidden">
      <section className=" w-full py-12 md:py-24 lg:py-32 xl:py-48">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          {/* this will show if the user is login if logout then simply it showing home page with navbar showing login,register button */}
           {
            user && <h1 className='font-bold text-2xl'>Welcome {user.username} 
            </h1> 
           }
