...
import { removeFromPastes } from "@/components/Todoredux/pasteslice";
import { FormatDate } from "@/Todoutlis/formateDate";
                ...
                >
                  ...
                  <div className="flex flex-col gap-y-4 sm:items-end">
                    <div className="flex flex-wrap gap-2 sm:flex-nowrap">
                      ...
                      >
                        <a href={`/create-todo/?pasteId=${paste?._id}`}>
                          <PencilLine
                      ...
                      <button className="p-2 rounded-[0.2rem] bg-white border border-[#c7c7c7]  hover:bg-transparent group hover:border-orange-500">
                        <a href={`/create-todo/pastes/${paste?._id}`} target="_blank">
                          <Eye
